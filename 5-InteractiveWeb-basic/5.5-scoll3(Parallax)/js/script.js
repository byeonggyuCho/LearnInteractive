...
let parallax_0,
  ...
  parallax_5,
  parallax_6;
let _offsetHeihgt, _outerHeight;
...
window.onload = function () {
  ...
  function stageResize() {
    _offsetHeihgt = window.offsetHeihgt;
    _outerHeight = window.outerHeihgt;
  }
  ...
  function loop() {
    ...
    parallax_4.style.transform = `translate3d(${mx / 140}px, ${
      scrollTop * 0.22
    }px, 0px)`;
    parallax_5.style.transform = `scale(1.1) translate(${mx / 50}px, ${
      scrollTop * 0.25
    }px)`;
